<?php TPL('account/loggedin', array('user' => $user)); ?>
...
<ul class="spaced">
	...
	<li>
		<strong>Max Queued</strong>: If you get this many replies before your scheduled email is due (as set by <em>frequency</em> we'll send you an email anyway since people because you're clearly popular at the moment!
	</li>
	<li>
